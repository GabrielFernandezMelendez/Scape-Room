  ...
  historyData.forEach((item) => {
    ...
    card.addEventListener("click", () => {
      ...
      if (item.text === "How to fix critical server error") {
        ...
        setTimeout(() => {
          // Pequeño retraso para que se vea el botón rojo
          mostrarPantalla(reto3);
        }, 500);
      } else {
        // FALLÓ — mensaje inline sin salir del reto
        const msgReto2 = document.getElementById("mensajeReto2");
        msgReto2.textContent =
          "That's not it. Keep looking through the history...";
        msgReto2.className = "mensaje incorrecto";
      }
    });
